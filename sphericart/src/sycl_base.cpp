...
void sphericart::intel::spherical_harmonics_sycl_base(
    const scalar_t* xyz,
    const int nedges,
...
template void sphericart::intel::spherical_harmonics_sycl_base<float>(
    const float *xyz,
    const int nedges,
...
template void sphericart::intel::spherical_harmonics_sycl_base<double>(
    const double* xyz,
    const int nedges,
...
template <typename scalar_t>
void sphericart::intel::spherical_harmonics_backward_sycl_base(
    const scalar_t* dsph,
...
template void sphericart::intel::spherical_harmonics_backward_sycl_base<float>(
    const float* dsph,
...
template void sphericart::intel::spherical_harmonics_backward_sycl_base<double>(
    const double* dsph,
